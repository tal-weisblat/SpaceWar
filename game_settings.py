...
from src.game_objects.flame import Flame
from src.db.get_table import getResults
...
# SOUND
pygame.mixer.music.load(os.path.join('resource/sounds', 'music.mp3'))  
pygame.mixer.music.play()
BULLET_FIRED_SOUND = pygame.mixer.Sound(os.path.join('resource/sounds', 'shooting.wav'))
BLAST_SOUND        = pygame.mixer.Sound(os.path.join('resource/sounds', 'blast.wav'))
GAME_OVER_SOUND    = pygame.mixer.Sound(os.path.join('resource/sounds', 'gameOver.wav'))
